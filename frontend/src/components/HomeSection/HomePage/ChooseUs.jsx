...
const ChooseUs = () => {
    return (
        <div className="px-4 lg:px-20">
            ...
            <div className="w-full flex flex-col lg:grid lg:grid-cols-[auto_auto_auto] gap-8 p-0 md:p-5 items-stretch justify-center">

                {/* Left Column */}
                <div className="flex flex-col justify-between w-full h-full space-y-6 items-center order-1 md:order-none">

                    <div className="w-full bg-[#4A94D0]/10 rounded-3xl flex flex-col justify-center px-6 text-left text-xl space-y-2 p-2">
                ...
                {/* Right Column */}
                <div className="flex flex-col justify-between w-full h-full space-y-6 items-center order-4 md:order-none">
